...
#include "../menu_composite/composite/menu_burger/header/menu_mcdonalds.hpp"
#include "../menu_composite/composite/menu_burger/header/menu_items_mcdonalds.hpp"
#include "../menu_composite/interface/menu_mcdonalds_display.hpp"
